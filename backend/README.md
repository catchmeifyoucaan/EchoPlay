...
- Authoritative Socket.IO gateway that authenticates JWTs, orchestrates rounds, timers, reactions, votes, and AI scoring broadcasts for `/realtime` matches.
...
- Scale the Socket.IO `/realtime` namespace with a Redis adapter and horizontal timer coordination.
